// Adapted from cloudflare/ai demos/remote-mcp-cf-access (MIT, Copyright (c) 2025 Cloudflare, Inc.).
...
export async function handleAccessRequest(
	...
	if (request.method === "GET" && pathname === "/authorize") {
		...
		return renderApprovalDialog(request, {
			...
			csrfToken,
			server: {
				description: "Delegate research, coding and file work to Kimi native AgentSwarm, running in your own isolated workspace.",
				name: "Kimi Swarm",
			},
			setCookie,
			state: { oauthReqInfo },
